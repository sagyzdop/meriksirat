...
export function DayView({
  ...
  const positionedEvents = useMemo(() => {
    ...
    sortedEvents.forEach((event) => {
      ...
      const top = (startHour - StartHour) * resolvedWeekCellsHeight
      const height = (endHour - startHour) * resolvedWeekCellsHeight
    ...
    return result
  }, [currentDate, timeEvents, resolvedWeekCellsHeight])
  ...
  return (
    <div data-slot="day-view" className="contents">
      ...
      <div className="border-border/70 grid flex-1 grid-cols-[3rem_1fr] overflow-y-auto border-t sm:grid-cols-[4rem_1fr]">
        <div>
