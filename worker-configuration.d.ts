/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b46279eceb5f8726c5f75dea9cc9a332)
// Runtime types generated with workerd@1.20260730.1 2025-09-02 enable_nodejs_http_modules,nodejs_compat
interface __BaseEnv_Env {
	meriksirat_kv: KVNamespace;
	meriksirat_r2: R2Bucket;
	meriksirat_d1: D1Database;
	rl_telegram_webhook: RateLimit;
	rl_images: RateLimit;
	rl_public_albums: RateLimit;
	rl_album_detail: RateLimit;
	rl_refresh_album: RateLimit;
	rl_create_upload_session: RateLimit;
	rl_create_booking: RateLimit;
	rl_add_booking_items: RateLimit;
	...
	GOOGLE_MASTER_ACCESS_TOKEN: string;
	GOOGLE_MASTER_REFRESH_TOKEN: string;
	TELEGRAM_BOT_TOKEN: string;
	TELEGRAM_CLUB_CHANNEL_ID: string;
	TELEGRAM_WEBHOOK_SECRET: string;
	TELEGRAM_BOT_USERNAME: string;
	TELEGRAM_RETURN_ENABLED: string;
	DEV: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_MASTER_ACCESS_TOKEN" | "GOOGLE_MASTER_REFRESH_TOKEN" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_CLUB_CHANNEL_ID" | "TELEGRAM_WEBHOOK_SECRET" | "TELEGRAM_BOT_USERNAME" | "TELEGRAM_RETURN_ENABLED" | "DEV">> {}
}
